...
//                .antMatchers("/cabang/update/**").hasAnyAuthority("Manager Cabang", "Kepala Retail")
                ...
                .antMatchers("/couponList/**").hasAnyAuthority("Kepala Retail", "Manager Cabang")
                .antMatchers("/couponApplied").hasAnyAuthority("Kepala Retail", "Manager Cabang")
                .antMatchers("/item/addItem/**").hasAnyAuthority("Kepala Retail", "Manager Cabang")
